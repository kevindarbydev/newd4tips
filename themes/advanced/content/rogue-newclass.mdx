...
cover: images/OfficialRogue.jpg
...
### Noteworthy Builds
The Rogue class has a ton of viable builds for both leveling and endgame, the shining star being the 'Twisting Blades' build. Some other great options are 'Death Trap' and 'Penetrating Shot'.
